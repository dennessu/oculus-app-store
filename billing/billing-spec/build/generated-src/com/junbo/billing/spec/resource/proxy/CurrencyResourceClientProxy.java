...
public class CurrencyResourceClientProxy implements com.junbo.billing.spec.resource.CurrencyResource {
    ...
    public CurrencyResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Currency>> getCurrencies() {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/currencies");
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Currency>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Currency>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.billing.spec.model.Currency>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.billing.spec.model.Currency>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.billing.spec.model.Currency> getCurrency(java.lang.String name) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/currencies/{name}");
        ...
        __uriBuilder.resolveTemplate("name", __pathParamTranscoder.encode(name));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.billing.spec.model.Currency>>() {
            @Override
            public Promise<com.junbo.billing.spec.model.Currency> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.billing.spec.model.Currency>decode(new TypeReference<com.junbo.billing.spec.model.Currency>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
