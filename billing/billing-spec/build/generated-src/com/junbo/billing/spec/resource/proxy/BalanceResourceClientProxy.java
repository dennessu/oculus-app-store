...
public class BalanceResourceClientProxy implements com.junbo.billing.spec.resource.BalanceResource {
    ...
    public BalanceResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.billing.spec.model.Balance> postBalance(com.junbo.billing.spec.model.Balance balance) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/balances");
        ...
        __requestBuilder.setBody(__transcoder.encode(balance));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.billing.spec.model.Balance>>() {
            @Override
            public Promise<com.junbo.billing.spec.model.Balance> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.billing.spec.model.Balance>decode(new TypeReference<com.junbo.billing.spec.model.Balance>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.billing.spec.model.Balance> quoteBalance(com.junbo.billing.spec.model.Balance balance) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/balances/quote");
    ...
    public Promise<com.junbo.billing.spec.model.Balance> captureBalance(com.junbo.billing.spec.model.Balance balance) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/balances/capture");
    ...
    public Promise<com.junbo.billing.spec.model.Balance> processAsyncBalance(com.junbo.billing.spec.model.Balance balance) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/balances/process-async");
    ...
    public Promise<com.junbo.billing.spec.model.Balance> getBalance(com.junbo.common.id.BalanceId balanceId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/balances/{balanceId}");
        ...
        __uriBuilder.resolveTemplate("balanceId", __pathParamTranscoder.encode(balanceId));
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Balance>> getBalances(com.junbo.common.id.OrderId orderId) {
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Balance>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.billing.spec.model.Balance>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.billing.spec.model.Balance>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.billing.spec.model.Balance>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
