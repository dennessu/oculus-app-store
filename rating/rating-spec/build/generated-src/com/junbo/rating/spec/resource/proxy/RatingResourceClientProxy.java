...
package com.junbo.rating.spec.resource.proxy;
...
public class RatingResourceClientProxy implements com.junbo.rating.spec.resource.RatingResource {
    ...
    public RatingResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.rating.spec.model.request.OfferRatingRequest> offerRating(com.junbo.rating.spec.model.request.OfferRatingRequest request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/rating/offers");
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.rating.spec.model.request.OfferRatingRequest>>() {
            @Override
            public Promise<com.junbo.rating.spec.model.request.OfferRatingRequest> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.rating.spec.model.request.OfferRatingRequest>decode(new TypeReference<com.junbo.rating.spec.model.request.OfferRatingRequest>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.rating.spec.model.request.OrderRatingRequest> orderRating(com.junbo.rating.spec.model.request.OrderRatingRequest request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/rating/order");
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.rating.spec.model.request.OrderRatingRequest>>() {
            @Override
            public Promise<com.junbo.rating.spec.model.request.OrderRatingRequest> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.rating.spec.model.request.OrderRatingRequest>decode(new TypeReference<com.junbo.rating.spec.model.request.OrderRatingRequest>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
