...
public class EndSessionEndpointClientProxy implements com.junbo.oauth.spec.endpoint.EndSessionEndpoint {
    ...
    public EndSessionEndpointClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<javax.ws.rs.core.Response> endSession(javax.ws.rs.core.UriInfo uriInfo, javax.ws.rs.core.HttpHeaders httpHeaders, javax.ws.rs.container.ContainerRequestContext request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/end-session");
