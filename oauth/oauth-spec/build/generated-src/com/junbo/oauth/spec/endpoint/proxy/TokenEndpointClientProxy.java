...
public class TokenEndpointClientProxy implements com.junbo.oauth.spec.endpoint.TokenEndpoint {
    ...
    public TokenEndpointClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.oauth.spec.model.AccessTokenResponse> postToken(javax.ws.rs.core.MultivaluedMap<java.lang.String,java.lang.String> formParams) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/token");
        ...
        __requestBuilder.setBody(__transcoder.encode(formParams));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.oauth.spec.model.AccessTokenResponse>>() {
            @Override
            public Promise<com.junbo.oauth.spec.model.AccessTokenResponse> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.oauth.spec.model.AccessTokenResponse>decode(new TypeReference<com.junbo.oauth.spec.model.AccessTokenResponse>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.oauth.spec.model.AccessTokenResponse> postToken(java.lang.String clientId, java.lang.String clientSecret, java.lang.String grantType, java.lang.String code, java.lang.String scope, java.lang.String redirectUri, java.lang.String username, java.lang.String password, java.lang.String refreshToken, java.lang.String nonce) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/token/explicit");
        ...
        __requestBuilder.addParameter("client_secret", clientSecret);
        }
            
        if (grantType != null) {
        __requestBuilder.addParameter("grant_type", grantType);
        }
            
        if (code != null) {
        __requestBuilder.addParameter("code", code);
        }
            
        if (scope != null) {
        __requestBuilder.addParameter("scope", scope);
        }
            
        if (redirectUri != null) {
        __requestBuilder.addParameter("redirect_uri", redirectUri);
        }
            
        if (username != null) {
        __requestBuilder.addParameter("username", username);
        }
            
        if (password != null) {
        __requestBuilder.addParameter("password", password);
        }
            
        if (refreshToken != null) {
        __requestBuilder.addParameter("refresh_token", refreshToken);
        }
            
        if (nonce != null) {
        __requestBuilder.addParameter("nonce", nonce);
        }
