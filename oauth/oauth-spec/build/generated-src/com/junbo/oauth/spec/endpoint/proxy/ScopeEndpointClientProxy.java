...
public class ScopeEndpointClientProxy implements com.junbo.oauth.spec.endpoint.ScopeEndpoint {
    ...
    public ScopeEndpointClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.oauth.spec.model.Scope> postScope(java.lang.String authorization, com.junbo.oauth.spec.model.Scope scope) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/scopes");
        ...
        __requestBuilder.setBody(__transcoder.encode(scope));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.oauth.spec.model.Scope>>() {
            @Override
            public Promise<com.junbo.oauth.spec.model.Scope> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.oauth.spec.model.Scope>decode(new TypeReference<com.junbo.oauth.spec.model.Scope>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.oauth.spec.model.Scope> getScope(java.lang.String authorization, java.lang.String scopeName) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/scopes/{scopeName}");
        ...
        __uriBuilder.resolveTemplate("scopeName", __pathParamTranscoder.encode(scopeName));
    ...
    public Promise<java.util.List<com.junbo.oauth.spec.model.Scope>> getByScopeNames(java.lang.String authorization, java.lang.String scopeNames) {
        ...
        if (scopeNames != null) {
            __requestBuilder.addQueryParameter("scopeNames", __queryParamTranscoder.encode(scopeNames));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<java.util.List<com.junbo.oauth.spec.model.Scope>>>() {
            @Override
            public Promise<java.util.List<com.junbo.oauth.spec.model.Scope>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<java.util.List<com.junbo.oauth.spec.model.Scope>>decode(new TypeReference<java.util.List<com.junbo.oauth.spec.model.Scope>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.oauth.spec.model.Scope> putScope(java.lang.String authorization, java.lang.String scopeName, com.junbo.oauth.spec.model.Scope scope) {
