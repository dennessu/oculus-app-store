...
public class TokenInfoEndpointClientProxy implements com.junbo.oauth.spec.endpoint.TokenInfoEndpoint {
    ...
    public TokenInfoEndpointClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.oauth.spec.model.TokenInfo> getTokenInfo(java.lang.String tokenValue) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/tokeninfo");
        ...
        if (tokenValue != null) {
            __requestBuilder.addQueryParameter("access_token", __queryParamTranscoder.encode(tokenValue));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.oauth.spec.model.TokenInfo>>() {
            @Override
            public Promise<com.junbo.oauth.spec.model.TokenInfo> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.oauth.spec.model.TokenInfo>decode(new TypeReference<com.junbo.oauth.spec.model.TokenInfo>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
