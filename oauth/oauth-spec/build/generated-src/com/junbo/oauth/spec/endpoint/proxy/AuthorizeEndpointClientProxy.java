...
public class AuthorizeEndpointClientProxy implements com.junbo.oauth.spec.endpoint.AuthorizeEndpoint {
    ...
    public AuthorizeEndpointClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<javax.ws.rs.core.Response> authorize(javax.ws.rs.core.UriInfo uriInfo, javax.ws.rs.core.HttpHeaders httpHeaders, javax.ws.rs.container.ContainerRequestContext request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/oauth2/authorize");
        ...
        __requestBuilder.setBody(__transcoder.encode(uriInfo));
    ...
    public Promise<javax.ws.rs.core.Response> postAuthorize(javax.ws.rs.core.HttpHeaders httpHeaders, javax.ws.rs.core.MultivaluedMap<java.lang.String,java.lang.String> formParams, javax.ws.rs.container.ContainerRequestContext request) {
