 ...
 */
package com.junbo.identity.data.telesign.telesign.util;
...
public class TeleSignRequest {
	...
	/**
	 * This method is used internally by the {@link com.junbo.identity.data.telesign.telesign.util.TeleSignRequest#executeRequest()} method.
	 *
	 * @param customer_id
	 *			[Required] A string representing your TeleSign Customer ID.
	 *			This represents your TeleSign account number.
