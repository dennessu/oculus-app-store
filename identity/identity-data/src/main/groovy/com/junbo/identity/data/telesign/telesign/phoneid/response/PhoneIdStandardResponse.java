 ...
 */
package com.junbo.identity.data.telesign.telesign.phoneid.response;
...
public class PhoneIdStandardResponse
{
	...
	/**
	 * Converts a <strong>PhoneIdStandardResponse</strong> object to its equivalent JSON format, using the {@link com.google.gson.Gson} class library.
