 ...
 */
package com.junbo.identity.data.telesign.telesign.phoneid;

import com.google.gson.Gson;
import com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdContactResponse;
import com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdLiveResponse;
import com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdScoreResponse;
import com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdStandardResponse;
import com.junbo.identity.data.telesign.telesign.util.TeleSignRequest;
...
public class PhoneId {
	 ...
	 *            information about.
	 * @return A {@link com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdStandardResponse}
	 ...
	 * @return A {@link com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdScoreResponse}
	 *         object, which contains the JSON-formatted response body from the
	 *         TeleSign server.
	 */
	 ...
	 * @param ucid
	 *            [Required] A string specifying one of the Use Case Codes.
	 * @return A {@link com.junbo.identity.data.telesign.telesign.phoneid.response.PhoneIdContactResponse}
	 *         object, which contains the JSON-formatted response body from the
	 *         TeleSign server.
	 */
