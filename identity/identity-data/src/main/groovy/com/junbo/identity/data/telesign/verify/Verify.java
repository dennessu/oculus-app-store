 ...
 */
package com.junbo.identity.data.telesign.verify;

import com.google.gson.Gson;
import com.junbo.identity.data.telesign.util.TeleSignRequest;
import com.junbo.identity.data.telesign.verify.response.VerifyResponse;
...
public class Verify {
	 ...
	 * @return A {@link com.junbo.identity.data.telesign.telesign.verify.response.VerifyResponse} object, which contains the JSON-formatted response body from the TeleSign server.
	 */
	 ...
	 * @param resource_id	[Required]	The string returned in the Response Message that TeleSign sends upon receipt of your HTTP 1.1 Request Message - for either {@link com.junbo.identity.data.telesign.telesign.verify#sms()} or {@link com.junbo.identity.data.telesign.telesign.verify#call()}.
	 * @return A {@link com.junbo.identity.data.telesign.telesign.verify.response.VerifyResponse} object, which contains the JSON-formatted response body from the TeleSign server.
	 */
