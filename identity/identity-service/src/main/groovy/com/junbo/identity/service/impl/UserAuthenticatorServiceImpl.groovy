...
class UserAuthenticatorServiceImpl implements UserAuthenticatorService {
    ...
    @Override
    Promise<Results<UserAuthenticator>> searchByUserIdAndTypeAndExternalId(UserId userId, String type, String externalId, Integer limit, Integer offset) {
        return userAuthenticatorRepository.searchByUserIdAndTypeAndExternalId(userId, type, externalId, limit, offset)
    }

    @Override
    Promise<Results<UserAuthenticator>> searchByUserIdAndExternalId(UserId userId, String externalId, Integer limit, Integer offset) {
        return userAuthenticatorRepository.searchByUserIdAndExternalId(userId, externalId, limit, offset)
    }

    @Override
    Promise<Results<UserAuthenticator>> searchByExternalIdAndType(String externalId, String type, Integer limit, Integer offset) {
