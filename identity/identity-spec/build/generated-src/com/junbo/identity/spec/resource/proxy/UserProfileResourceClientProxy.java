...
public class UserProfileResourceClientProxy implements com.junbo.identity.spec.resource.UserProfileResource {
    ...
    public UserProfileResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.identity.spec.model.user.UserProfile> postUserProfile(com.junbo.common.id.UserId userId, com.junbo.identity.spec.model.user.UserProfile userProfile) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{key1}/profiles");
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.identity.spec.model.user.UserProfile>>() {
            @Override
            public Promise<com.junbo.identity.spec.model.user.UserProfile> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.identity.spec.model.user.UserProfile>decode(new TypeReference<com.junbo.identity.spec.model.user.UserProfile>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserProfile>> getUserProfiles(com.junbo.common.id.UserId userId, java.lang.String type, java.lang.Integer cursor, java.lang.Integer count) {
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserProfile>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserProfile>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserProfile>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserProfile>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.identity.spec.model.user.UserProfile> getUserProfile(com.junbo.common.id.UserId userId, com.junbo.common.id.UserProfileId profileId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{key1}/profiles/{key2}");
        ...
        __uriBuilder.resolveTemplate("key2", __pathParamTranscoder.encode(profileId));
    ...
    public Promise<com.junbo.identity.spec.model.user.UserProfile> updateUserProfile(com.junbo.common.id.UserId userId, com.junbo.common.id.UserProfileId profileId, com.junbo.identity.spec.model.user.UserProfile userProfile) {
    ...
    public Promise<java.lang.Void> deleteUserProfile(com.junbo.common.id.UserId userId, com.junbo.common.id.UserProfileId profileId) {
