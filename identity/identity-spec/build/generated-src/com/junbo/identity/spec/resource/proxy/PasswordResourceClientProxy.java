...
public class PasswordResourceClientProxy implements com.junbo.identity.spec.resource.PasswordResource {
    ...
    public PasswordResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.identity.spec.model.password.PasswordRule> getPasswordRule(com.junbo.common.id.PasswordRuleId passwordRuleId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/password-rules/{passwordRuleId}");
        ...
        __uriBuilder.resolveTemplate("passwordRuleId", __pathParamTranscoder.encode(passwordRuleId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.identity.spec.model.password.PasswordRule>>() {
            @Override
            public Promise<com.junbo.identity.spec.model.password.PasswordRule> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.identity.spec.model.password.PasswordRule>decode(new TypeReference<com.junbo.identity.spec.model.password.PasswordRule>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.identity.spec.model.password.PasswordRule> postPasswordRule(com.junbo.identity.spec.model.password.PasswordRule passwordRule) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/password-rules/");
        ...
        __requestBuilder.setBody(__transcoder.encode(passwordRule));
    ...
    public Promise<com.junbo.identity.spec.model.password.PasswordRule> updatePasswordRule(com.junbo.common.id.PasswordRuleId passwordRuleId, com.junbo.identity.spec.model.password.PasswordRule passwordRule) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/password-rules/{appId}");
