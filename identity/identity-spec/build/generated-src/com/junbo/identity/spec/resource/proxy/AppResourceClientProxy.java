...
public class AppResourceClientProxy implements com.junbo.identity.spec.resource.AppResource {
    ...
    public AppResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.identity.spec.model.app.App> getApp(com.junbo.common.id.AppId appId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("identity/apps/{appId}");
        ...
        __uriBuilder.resolveTemplate("appId", __pathParamTranscoder.encode(appId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.identity.spec.model.app.App>>() {
            @Override
            public Promise<com.junbo.identity.spec.model.app.App> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.identity.spec.model.app.App>decode(new TypeReference<com.junbo.identity.spec.model.app.App>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.identity.spec.model.app.App> postApp(com.junbo.identity.spec.model.app.App app) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("identity/apps/");
        ...
        __requestBuilder.setBody(__transcoder.encode(app));
    ...
    public Promise<com.junbo.identity.spec.model.app.App> updateApp(com.junbo.common.id.AppId appId, com.junbo.identity.spec.model.app.App app) {
    ...
    public Promise<com.junbo.identity.spec.model.app.App> deleteApp(com.junbo.common.id.AppId appId) {
