...
public class UserTosAcceptanceResourceClientProxy implements com.junbo.identity.spec.resource.UserTosAcceptanceResource {
    ...
    public UserTosAcceptanceResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.identity.spec.model.user.UserTosAcceptance> postUserTosAcceptance(com.junbo.common.id.UserId userId, com.junbo.identity.spec.model.user.UserTosAcceptance userTosAcceptance) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{key1}/tos-acceptances");
        ...
        __requestBuilder.setBody(__transcoder.encode(userTosAcceptance));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.identity.spec.model.user.UserTosAcceptance>>() {
            @Override
            public Promise<com.junbo.identity.spec.model.user.UserTosAcceptance> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.identity.spec.model.user.UserTosAcceptance>decode(new TypeReference<com.junbo.identity.spec.model.user.UserTosAcceptance>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserTosAcceptance>> getUserTosAcceptances(com.junbo.common.id.UserId userId, java.lang.String tos, java.lang.Integer cursor, java.lang.Integer count) {
        ...
        if (tos != null) {
            __requestBuilder.addQueryParameter("tos", __queryParamTranscoder.encode(tos));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserTosAcceptance>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserTosAcceptance>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserTosAcceptance>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.identity.spec.model.user.UserTosAcceptance>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.identity.spec.model.user.UserTosAcceptance> getUserTosAcceptance(com.junbo.common.id.UserId userId, com.junbo.common.id.UserTosAcceptanceId tosAcceptanceId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{key1}/tos-acceptances/{key2}");
        ...
        __uriBuilder.resolveTemplate("key2", __pathParamTranscoder.encode(tosAcceptanceId));
    ...
    public Promise<com.junbo.identity.spec.model.user.UserTosAcceptance> updateUserTosAcceptance(com.junbo.common.id.UserId userId, com.junbo.common.id.UserTosAcceptanceId tosAcceptanceId, com.junbo.identity.spec.model.user.UserTosAcceptance userTosAcceptance) {
    ...
    public Promise<java.lang.Void> deleteUserTosAcceptance(com.junbo.common.id.UserId userId, com.junbo.common.id.UserTosAcceptanceId tosAcceptanceId) {
