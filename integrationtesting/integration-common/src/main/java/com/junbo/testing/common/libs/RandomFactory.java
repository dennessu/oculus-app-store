...
public final class RandomFactory {
    private static final String alphabetAndNumericCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
    ...
    */
    ...
    public static String getRandomStringOfAlphabetOrNumeric(int stringLength) {
        ...
        for (int i = 0; i < stringLength; i++) {
            randomString.append(alphabetAndNumericCharacters.charAt(random.nextInt(alphabetAndNumericCharacters.length())));
        }
