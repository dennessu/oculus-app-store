...
public interface PaymentService {
    String addPaymentInstrument(String uid, PaymentInstrument paymentInstrument) throws Exception;

    String addPaymentInstrument(String uid, PaymentInstrument paymentInstrument,
