...
def generateRandomKey(keysize):
    ...
    return os.urandom(keysize).encode('hex').upper()

def usage():
    print("Usage:")
    print("  AESCipher.py encrypt key clearText")
    print("  AESCipher.py decrypt key encryptedText")
    print("  AESCipher.py genkey")
    print("Examples:")
...
if __name__ == "__main__":
    ...
    if sys.argv[1] == 'encrypt' and len(sys.argv) == 4:
        key = sys.argv[2]
        clearText = sys.argv[3]
        print(encryptData(key, clearText))
        exit(0)
    elif sys.argv[1] == 'decrypt' and len(sys.argv) == 4:
        key = sys.argv[2]
        encryptedText = sys.argv[3]
        print(decryptData(key, encryptedText))
        exit(0)
    elif sys.argv[1] == 'genkey':
        print(generateRandomKey(16))
        exit(0)
    usage()
