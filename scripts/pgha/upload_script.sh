...
scp -o "StrictHostKeyChecking no" -r ./ $DEPLOYMENT_ACCOUNT@$MASTER_HOST:$DEPLOYMENT_PATH
...
scp -o "StrictHostKeyChecking no" -r ./ $DEPLOYMENT_ACCOUNT@$SLAVE_HOST:$DEPLOYMENT_PATH
...
scp -o "StrictHostKeyChecking no" -r ./ $DEPLOYMENT_ACCOUNT@$BCP_HOST:$DEPLOYMENT_PATH
...
scp -o "StrictHostKeyChecking no" -r ./ $DEPLOYMENT_ACCOUNT@$REPLICA_HOST:$DEPLOYMENT_PATH
