...
public class ConfigurationTest {
    ...
    private ConfigService oldConfigService;
    ...
    public void setup() {
        ...
        try {
            ...
            oldConfigService = ConfigServiceManager.instance();
            ConfigServiceManager.setInstance(new ConfigServiceImpl());
        }
        catch (Exception ex) {
    ...
    public void teardown() {
        ...
        System.clearProperty("configDir");
        System.clearProperty("environment");
        ConfigServiceManager.setInstance(oldConfigService);
    }

    @Test
    public void testLoadConfig() {
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath*:spring/configuration-test.xml");
