...
public class AttributeResourceClientProxy implements com.junbo.catalog.spec.resource.AttributeResource {
    ...
    public AttributeResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.catalog.spec.model.attribute.Attribute> getAttribute(com.junbo.common.id.AttributeId attributeId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("attributes/{attributeId}");
        ...
        __uriBuilder.resolveTemplate("attributeId", __pathParamTranscoder.encode(attributeId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.catalog.spec.model.attribute.Attribute>>() {
            @Override
            public Promise<com.junbo.catalog.spec.model.attribute.Attribute> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.catalog.spec.model.attribute.Attribute>decode(new TypeReference<com.junbo.catalog.spec.model.attribute.Attribute>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.attribute.Attribute>> getAttributes(com.junbo.catalog.spec.model.attribute.AttributesGetOptions options) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("attributes/");
        ...
        if (options.getAttributeIds() != null) {
        for (com.junbo.common.id.AttributeId __item : options.getAttributeIds()) {
        __requestBuilder.addQueryParameter("id", __queryParamTranscoder.encode(__item));
        }
        }
        
        if (options.getAttributeType() != null) {
            __requestBuilder.addQueryParameter("type", __queryParamTranscoder.encode(options.getAttributeType()));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.attribute.Attribute>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.attribute.Attribute>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.catalog.spec.model.attribute.Attribute>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.catalog.spec.model.attribute.Attribute>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.catalog.spec.model.attribute.Attribute> createAttribute(com.junbo.catalog.spec.model.attribute.Attribute attribute) {
        ...
        __requestBuilder.setBody(__transcoder.encode(attribute));
