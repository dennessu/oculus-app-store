...
public class ItemResourceClientProxy implements com.junbo.catalog.spec.resource.ItemResource {
    ...
    public ItemResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.item.Item>> getItems(com.junbo.catalog.spec.model.item.ItemsGetOptions options) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("items/");
        ...
        if (options.getItemIds() != null) {
        for (com.junbo.common.id.ItemId __item : options.getItemIds()) {
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.item.Item>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.item.Item>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.catalog.spec.model.item.Item>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.catalog.spec.model.item.Item>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.catalog.spec.model.item.Item> getItem(com.junbo.common.id.ItemId itemId, com.junbo.catalog.spec.model.common.EntityGetOptions options) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("items/{itemId}");
        ...
        __uriBuilder.resolveTemplate("itemId", __pathParamTranscoder.encode(itemId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.catalog.spec.model.item.Item>>() {
            @Override
            public Promise<com.junbo.catalog.spec.model.item.Item> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.catalog.spec.model.item.Item>decode(new TypeReference<com.junbo.catalog.spec.model.item.Item>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.catalog.spec.model.item.Item> create(com.junbo.catalog.spec.model.item.Item item) {
        ...
        __requestBuilder.setBody(__transcoder.encode(item));
    ...
    public Promise<com.junbo.catalog.spec.model.item.Item> update(com.junbo.common.id.ItemId itemId, com.junbo.catalog.spec.model.item.Item item) {
    ...
    public Promise<javax.ws.rs.core.Response> delete(com.junbo.common.id.ItemId itemId) {
