...
public class PromotionResourceClientProxy implements com.junbo.catalog.spec.resource.PromotionResource {
    ...
    public PromotionResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.promotion.Promotion>> getPromotions(com.junbo.catalog.spec.model.promotion.PromotionsGetOptions options) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("promotions/");
        ...
        if (options.getPromotionIds() != null) {
        for (com.junbo.common.id.PromotionId __item : options.getPromotionIds()) {
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.promotion.Promotion>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.catalog.spec.model.promotion.Promotion>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.catalog.spec.model.promotion.Promotion>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.catalog.spec.model.promotion.Promotion>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.catalog.spec.model.promotion.Promotion> getPromotion(com.junbo.common.id.PromotionId promotionId, com.junbo.catalog.spec.model.common.EntityGetOptions options) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("promotions/{promotionId}");
        ...
        __uriBuilder.resolveTemplate("promotionId", __pathParamTranscoder.encode(promotionId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.catalog.spec.model.promotion.Promotion>>() {
            @Override
            public Promise<com.junbo.catalog.spec.model.promotion.Promotion> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.catalog.spec.model.promotion.Promotion>decode(new TypeReference<com.junbo.catalog.spec.model.promotion.Promotion>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.catalog.spec.model.promotion.Promotion> create(com.junbo.catalog.spec.model.promotion.Promotion promotion) {
        ...
        __requestBuilder.setBody(__transcoder.encode(promotion));
    ...
    public Promise<com.junbo.catalog.spec.model.promotion.Promotion> update(com.junbo.common.id.PromotionId promotionId, com.junbo.catalog.spec.model.promotion.Promotion promotion) {
    ...
    public Promise<javax.ws.rs.core.Response> delete(com.junbo.common.id.PromotionId promotionId) {
