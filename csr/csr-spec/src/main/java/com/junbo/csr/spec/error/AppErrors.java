...
public interface AppErrors {
    ...
    @ErrorDef(httpStatusCode = 400, code = "900001", message = "Csr log {0} not found.", field = "{0}")
    AppError csrLogNotFound(CsrLogId csrLogId);

    @ErrorDef(httpStatusCode = 400, code = "900002", message = "Invalid csr log search condition.")
    AppError invalidCsrLogSearch();

    @ErrorDef(httpStatusCode = 400, code = "900003", message = "Exceed csr log search range max limit days.")
    AppError exceedCsrLogSearchRange();

    @ErrorDef(httpStatusCode = 400, code = "900004", message = "Invalid country code.")
    AppError invalidCountryCode();

    @ErrorDef(httpStatusCode = 400, code = "900005", message = "User not found.")
    AppError userNotFound();

    @ErrorDef(httpStatusCode = 400, code = "900006", message = "Group not found.")
    AppError groupNotFound();

    @ErrorDef(httpStatusCode = 400, code = "900007", message = "Field {0} not writable.", field = "{0}")
    AppError fieldNotWritable(String field);

    @ErrorDef(httpStatusCode = 400, code = "900008", message = "Field {0} invalid. Allowed values: {1}",
            field = "{0}")
    AppError fieldInvalid(String field, String allowedValues);

    @ErrorDef(httpStatusCode = 400, code = "900009", message = "Field {0} invalid.", field = "{0}")
    AppError fieldInvalid(String field);

    @ErrorDef(httpStatusCode = 400, code = "900010", message = "Field {0} required.", field = "{0}")
    AppError fieldRequired(String field);

    @ErrorDef(httpStatusCode = 400, code = "900011", message = "Csr update {0} not found.", field = "{0}")
    ...
    @ErrorDef(httpStatusCode = 400, code = "900017", message = "Pending csr group not found.")
    AppError pendingCsrGroupNotFound();

    @ErrorDef(httpStatusCode = 400, code = "900018", message = "Email template not found.")
    AppError emailTemplateNotFound();

    @ErrorDef(httpStatusCode = 400, code = "900019", message = "Send email failed.")
