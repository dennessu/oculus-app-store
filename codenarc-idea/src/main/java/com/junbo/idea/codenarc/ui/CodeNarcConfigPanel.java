...
import com.junbo.idea.codenarc.util.ExtensionFileChooserDescriptor;
import com.junbo.idea.codenarc.util.IDEAUtilities;
import com.junbo.idea.codenarc.util.ObjectUtils;
 ...
 */
public final class CodeNarcConfigPanel extends JPanel {
    private final JList pathList = new JBList(new DefaultListModel());

    private final JCheckBox testClassesCheckbox = new JCheckBox();
    private final JCheckBox scanNonGroovyFilesCheckbox = new JCheckBox();
    ...
    private boolean scanNonGroovyFiles;
    ...
    public CodeNarcConfigPanel(@NotNull final Project project) {
    ...
    private JPanel buildConfigPanel() {
        ...
        scanNonGroovyFilesCheckbox.setText(resources.getString("config.scan-nongroovy-files.checkbox.text"));
        scanNonGroovyFilesCheckbox.setToolTipText(resources.getString("config.scan-nongroovy-files.checkbox.tooltip"));
        ...
        configFilePanel.add(scanNonGroovyFilesCheckbox, new GridBagConstraints(
     ...
     *
     * @param scanNonGroovyFiles true to scan all files types, false to scan only Java files.
     */
    public void setScanNonGroovyFiles(final boolean scanNonGroovyFiles) {
        this.scanNonGroovyFiles = scanNonGroovyFiles;
        scanNonGroovyFilesCheckbox.setSelected(scanNonGroovyFiles);
    }
     ...
     */
    public boolean isScanNonGroovyFiles() {
        scanNonGroovyFiles = scanNonGroovyFilesCheckbox.isSelected();
        return scanNonGroovyFiles;
    }
    ...
    public boolean isModified() throws IOException {
        return haveLocationsChanged()
                ...
                || scanNonGroovyFilesCheckbox.isSelected() != scanNonGroovyFiles
