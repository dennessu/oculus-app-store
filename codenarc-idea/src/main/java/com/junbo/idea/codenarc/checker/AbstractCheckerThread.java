...
public abstract class AbstractCheckerThread extends Thread {
    ...
    public AbstractCheckerThread(@NotNull final CodeNarcPlugin codeNarcPlugin,
    ...
    @Nullable
    protected CodeNarcToolWindowPanel toolWindowPanel() {
        return CodeNarcToolWindowPanel.panelFor(plugin.getProject());
    }
