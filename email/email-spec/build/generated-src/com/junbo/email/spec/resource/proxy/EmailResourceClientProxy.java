...
public class EmailResourceClientProxy implements com.junbo.email.spec.resource.EmailResource {
    ...
    public EmailResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.email.spec.model.Email> postEmail(com.junbo.email.spec.model.Email email) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/emails");
        ...
        __requestBuilder.setBody(__transcoder.encode(email));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.email.spec.model.Email>>() {
            @Override
            public Promise<com.junbo.email.spec.model.Email> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.email.spec.model.Email>decode(new TypeReference<com.junbo.email.spec.model.Email>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.email.spec.model.Email> getEmail(com.junbo.common.id.EmailId id) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/emails/{id}");
    ...
    public Promise<com.junbo.email.spec.model.Email> putEmail(com.junbo.common.id.EmailId id, com.junbo.email.spec.model.Email email) {
    ...
    public Promise<javax.ws.rs.core.Response> deleteEmail(com.junbo.common.id.EmailId id) {
