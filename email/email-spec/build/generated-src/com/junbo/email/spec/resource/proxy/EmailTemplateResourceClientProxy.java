...
package com.junbo.email.spec.resource.proxy;
...
public class EmailTemplateResourceClientProxy implements com.junbo.email.spec.resource.EmailTemplateResource {
    ...
    public EmailTemplateResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.email.spec.model.EmailTemplate>> getEmailTemplates(com.junbo.email.spec.model.Paging paging) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/email-templates");
        ...
        if (paging.getPage() != null) {
            __requestBuilder.addQueryParameter("page", __queryParamTranscoder.encode(paging.getPage()));
        }
        
        if (paging.getSize() != null) {
            __requestBuilder.addQueryParameter("size", __queryParamTranscoder.encode(paging.getSize()));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.email.spec.model.EmailTemplate>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.email.spec.model.EmailTemplate>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.email.spec.model.EmailTemplate>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.email.spec.model.EmailTemplate>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.email.spec.model.EmailTemplate> postEmailTemplate(com.junbo.email.spec.model.EmailTemplate template) {
        ...
        __requestBuilder.setBody(__transcoder.encode(template));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.email.spec.model.EmailTemplate>>() {
            @Override
            public Promise<com.junbo.email.spec.model.EmailTemplate> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.email.spec.model.EmailTemplate>decode(new TypeReference<com.junbo.email.spec.model.EmailTemplate>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.email.spec.model.EmailTemplate> getEmailTemplate(com.junbo.common.id.EmailId id) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/email-templates/{id}");
        ...
        __uriBuilder.resolveTemplate("id", __pathParamTranscoder.encode(id));
    ...
    public Promise<com.junbo.email.spec.model.EmailTemplate> putEmailTemplate(com.junbo.common.id.EmailId id, com.junbo.email.spec.model.EmailTemplate template) {
    ...
    public Promise<javax.ws.rs.core.Response> deleteEmailTemplate(com.junbo.common.id.EmailId id) {
