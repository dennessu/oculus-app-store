...
public class OrderEventResourceClientProxy implements com.junbo.order.spec.resource.OrderEventResource {
    ...
    public OrderEventResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.OrderEvent>> getOrderEvents(com.junbo.common.id.OrderId orderId, com.junbo.order.spec.model.PageParam pageParam, javax.ws.rs.core.HttpHeaders headers) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("order-events");
        ...
        if (pageParam.getStart() != null) {
            __requestBuilder.addQueryParameter("start", __queryParamTranscoder.encode(pageParam.getStart()));
        }
        
        if (pageParam.getCount() != null) {
            __requestBuilder.addQueryParameter("count", __queryParamTranscoder.encode(pageParam.getCount()));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.OrderEvent>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.OrderEvent>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.order.spec.model.OrderEvent>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.order.spec.model.OrderEvent>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.order.spec.model.OrderEvent> createOrderEvent(com.junbo.order.spec.model.OrderEvent orderEvent, javax.ws.rs.core.HttpHeaders headers) {
        ...
        __requestBuilder.setBody(__transcoder.encode(orderEvent));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.order.spec.model.OrderEvent>>() {
            @Override
            public Promise<com.junbo.order.spec.model.OrderEvent> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.order.spec.model.OrderEvent>decode(new TypeReference<com.junbo.order.spec.model.OrderEvent>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
