...
public class OrderResourceClientProxy implements com.junbo.order.spec.resource.OrderResource {
    ...
    public OrderResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.order.spec.model.Order> createOrder(com.junbo.order.spec.model.Order order) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("orders");
        ...
        __requestBuilder.setBody(__transcoder.encode(order));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.order.spec.model.Order>>() {
            @Override
            public Promise<com.junbo.order.spec.model.Order> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.order.spec.model.Order>decode(new TypeReference<com.junbo.order.spec.model.Order>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.order.spec.model.Order> getOrderByOrderId(com.junbo.common.id.OrderId orderId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("orders/{orderId}");
        ...
        __uriBuilder.resolveTemplate("orderId", __pathParamTranscoder.encode(orderId));
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.Order>> getOrderByUserId(com.junbo.common.id.UserId userId, com.junbo.order.spec.model.OrderQueryParam orderQueryParam, com.junbo.order.spec.model.PageParam pageParam) {
        ...
        if (userId != null) {
            __requestBuilder.addQueryParameter("userId", __queryParamTranscoder.encode(userId));
        }
            
        
        if (orderQueryParam.getTentative() != null) {
            __requestBuilder.addQueryParameter("tentative", __queryParamTranscoder.encode(orderQueryParam.getTentative()));
        }
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.Order>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.order.spec.model.Order>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.order.spec.model.Order>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.order.spec.model.Order>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.order.spec.model.Order> updateOrderByOrderId(com.junbo.common.id.OrderId orderId, com.junbo.order.spec.model.Order order) {
