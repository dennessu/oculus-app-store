 ...
 */
public class CloudantIdSerializer extends JsonSerializer<CloudantId> {

    @Override
    public void serialize(CloudantId value, JsonGenerator jgen, SerializerProvider provider)
            throws IOException {
