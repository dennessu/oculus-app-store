...
package com.junbo.ewallet.spec.resource.proxy;
...
public class WalletResourceClientProxy implements com.junbo.ewallet.spec.resource.WalletResource {
    ...
    public WalletResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> getWallet(com.junbo.common.id.WalletId walletId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/wallets/{walletId}");
        ...
        __uriBuilder.resolveTemplate("walletId", __pathParamTranscoder.encode(walletId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.ewallet.spec.model.Wallet>>() {
            @Override
            public Promise<com.junbo.ewallet.spec.model.Wallet> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.ewallet.spec.model.Wallet>decode(new TypeReference<com.junbo.ewallet.spec.model.Wallet>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> postWallet(com.junbo.ewallet.spec.model.Wallet wallet) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/wallets");
        ...
        __requestBuilder.setBody(__transcoder.encode(wallet));
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> updateWallet(com.junbo.common.id.WalletId walletId, com.junbo.ewallet.spec.model.Wallet wallet) {
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> credit(com.junbo.common.id.WalletId walletId, com.junbo.ewallet.spec.model.CreditRequest creditRequest) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/wallets/{walletId}/credit");
        ...
        __requestBuilder.setBody(__transcoder.encode(creditRequest));
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> debit(com.junbo.common.id.WalletId walletId, com.junbo.ewallet.spec.model.DebitRequest debitRequest) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/wallets/{walletId}/debit");
        ...
        __requestBuilder.setBody(__transcoder.encode(debitRequest));
    ...
    public Promise<com.junbo.ewallet.spec.model.Wallet> getTransactions(com.junbo.common.id.WalletId walletId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/wallets/{walletId}/transactions");
