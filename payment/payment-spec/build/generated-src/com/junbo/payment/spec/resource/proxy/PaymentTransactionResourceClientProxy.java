...
public class PaymentTransactionResourceClientProxy implements com.junbo.payment.spec.resource.PaymentTransactionResource {
    ...
    public PaymentTransactionResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.payment.spec.model.PaymentTransaction> postPaymentAuthorization(com.junbo.payment.spec.model.PaymentTransaction request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-transactions/authorization");
    ...
    public Promise<com.junbo.payment.spec.model.PaymentTransaction> postPaymentCapture(java.lang.Long paymentId, com.junbo.payment.spec.model.PaymentTransaction request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-transactions/{paymentId}/capture");
        ...
        __uriBuilder.resolveTemplate("paymentId", __pathParamTranscoder.encode(paymentId));
    ...
    public Promise<com.junbo.payment.spec.model.PaymentTransaction> postPaymentCharge(com.junbo.payment.spec.model.PaymentTransaction request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-transactions/charge");
    ...
    public Promise<com.junbo.payment.spec.model.PaymentTransaction> reversePayment(java.lang.Long paymentId, com.junbo.payment.spec.model.PaymentTransaction request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-transactions/{paymentId}/reverse");
    ...
    public Promise<com.junbo.payment.spec.model.PaymentTransaction> getPayment(java.lang.Long paymentId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-transactions/{paymentId}");
