...
public class PaymentInstrumentTypeResourceClientProxy implements com.junbo.payment.spec.resource.PaymentInstrumentTypeResource {
    ...
    public PaymentInstrumentTypeResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.payment.spec.model.PaymentInstrumentType> getById(java.lang.String paymentInstrumentType) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/payment-instrument-types/{paymentInstrumentType}");
        ...
        __uriBuilder.resolveTemplate("paymentInstrumentType", __pathParamTranscoder.encode(paymentInstrumentType));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.payment.spec.model.PaymentInstrumentType>>() {
            @Override
            public Promise<com.junbo.payment.spec.model.PaymentInstrumentType> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.payment.spec.model.PaymentInstrumentType>decode(new TypeReference<com.junbo.payment.spec.model.PaymentInstrumentType>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
