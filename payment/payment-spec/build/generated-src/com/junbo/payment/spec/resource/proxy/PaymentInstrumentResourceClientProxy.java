...
package com.junbo.payment.spec.resource.proxy;
...
public class PaymentInstrumentResourceClientProxy implements com.junbo.payment.spec.resource.PaymentInstrumentResource {
    ...
    public PaymentInstrumentResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.payment.spec.model.PaymentInstrument> postPaymentInstrument(com.junbo.common.id.UserId userId, com.junbo.payment.spec.model.PaymentInstrument request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{userId}/payment-instruments");
    ...
    public Promise<com.junbo.payment.spec.model.PaymentInstrument> getById(com.junbo.common.id.UserId userId, com.junbo.common.id.PaymentInstrumentId paymentInstrumentId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/users/{userId}/payment-instruments/{paymentInstrumentId}");
        ...
        __uriBuilder.resolveTemplate("paymentInstrumentId", __pathParamTranscoder.encode(paymentInstrumentId));
    ...
    public Promise<javax.ws.rs.core.Response> delete(com.junbo.common.id.UserId userId, com.junbo.common.id.PaymentInstrumentId paymentInstrumentId) {
    ...
    public Promise<com.junbo.payment.spec.model.PaymentInstrument> update(com.junbo.common.id.UserId userId, com.junbo.common.id.PaymentInstrumentId paymentInstrumentId, com.junbo.payment.spec.model.PaymentInstrument request) {
    ...
    public Promise<com.junbo.common.model.Results<com.junbo.payment.spec.model.PaymentInstrument>> searchPaymentInstrument(com.junbo.common.id.UserId userId, com.junbo.payment.spec.model.PaymentInstrumentSearchParam searchParam, com.junbo.payment.spec.model.PageMetaData pageMetadata) {
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.common.model.Results<com.junbo.payment.spec.model.PaymentInstrument>>>() {
            @Override
            public Promise<com.junbo.common.model.Results<com.junbo.payment.spec.model.PaymentInstrument>> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.common.model.Results<com.junbo.payment.spec.model.PaymentInstrument>>decode(new TypeReference<com.junbo.common.model.Results<com.junbo.payment.spec.model.PaymentInstrument>>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
