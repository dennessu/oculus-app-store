...
package com.junbo.fulfilment.spec.resource.proxy;
...
public class FulfilmentResourceClientProxy implements com.junbo.fulfilment.spec.resource.FulfilmentResource {
    ...
    public FulfilmentResourceClientProxy(AsyncHttpClient client, MessageTranscoder transcoder, PathParamTranscoder pathParamTranscoder,
    ...
    public Promise<com.junbo.fulfilment.spec.model.FulfilmentRequest> fulfill(com.junbo.fulfilment.spec.model.FulfilmentRequest request) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/fulfilments/");
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.fulfilment.spec.model.FulfilmentRequest>>() {
            @Override
            public Promise<com.junbo.fulfilment.spec.model.FulfilmentRequest> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.fulfilment.spec.model.FulfilmentRequest>decode(new TypeReference<com.junbo.fulfilment.spec.model.FulfilmentRequest>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
    ...
    public Promise<com.junbo.fulfilment.spec.model.FulfilmentRequest> getByOrderId(com.junbo.common.id.OrderId orderId) {
    ...
    public Promise<com.junbo.fulfilment.spec.model.FulfilmentItem> getByFulfilmentId(com.junbo.common.id.FulfilmentId fulfilmentId) {
    
        javax.ws.rs.core.UriBuilder __uriBuilder = UriBuilder.fromUri(__target);
        __uriBuilder.path("/fulfilments/{fulfilmentId}");
        ...
        __uriBuilder.resolveTemplate("fulfilmentId", __pathParamTranscoder.encode(fulfilmentId));
        ...
        return __future.then(new Promise.Func<Response, Promise<com.junbo.fulfilment.spec.model.FulfilmentItem>>() {
            @Override
            public Promise<com.junbo.fulfilment.spec.model.FulfilmentItem> apply(Response response) {
                if (response.getStatusCode() / 100 == 2) {
                    try {
                        return Promise.pure(__transcoder.<com.junbo.fulfilment.spec.model.FulfilmentItem>decode(new TypeReference<com.junbo.fulfilment.spec.model.FulfilmentItem>() {}, response.getResponseBody()));
                    } catch (java.io.IOException ex) {
                         throw new RuntimeException(ex);
                    }
                } else {
