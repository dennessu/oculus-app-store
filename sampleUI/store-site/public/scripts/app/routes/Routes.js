...
], function(Ember, auth, cartRestAdapter){
          ...
          if(Ember.App.AuthManager.isAuthenticated()){
              ...
              this.store.find("CartItem").then(function(records){
                  ...
                  for(var i = 0; i<arr.length; ++i){
                      ...
                      $.post("/api/addcartitem", { userId: arr[i].user_id, productId: arr[i].product_id, count: arr[i].count } );
                  }
              });
          }
      },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < resData.CartItems.length; ++i) {
                            ...
                            console.log("[CartRout]Push to Store, Product Id: " + item.product_id);
                        }
                    }});
