module.exports = {
    ...
    LoginBackUrl: "http://127.0.0.1/auth/login",
    LoginUrl: "http://54.186.20.200:8081/rest/authorize?client_id=client&response_type=code&redirect_uri=http://127.0.0.1/auth/login&scope=openid%20identity&nonce=123",
    //LoginUrl: "http://127.0.0.1:3000?fs=flow_state&redirect_url=http://localhost:3100/auth/login",
    RegisterUrl: "http://127.0.0.1:81/?redirect_url=http://127.0.0.1/auth/register#/register"
